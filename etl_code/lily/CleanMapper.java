...
public class CleanMapper extends Mapper<Object, Text, Text, Text> {
    ...
    public void map(Object key, Text value, Context context)
        ...
        /*
        Cleaning Objectives:
        1. Remove rows with missing or malformed data
        2. Remove unnecessary columns
        3. Add a season column (summer/winter) based on the month
        4. Add soldOut column if capacity is >= 100
        */
        ...
        try {
            ...
            for (CSVRecord record : records) {
                ...
                double capacityValue = Double.parseDouble(capacity);
                ...
                String soldOut = capacityValue >= 100 ? "1" : "0";

                String csv = year + "," + season + "," + attendance + "," + capacity + "," + gross + "," + soldOut;
